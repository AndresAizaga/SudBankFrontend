...
import { L06NewRegisterComponent } from '../../../components/l06/l06-new-register/l06-new-register.component';


@Component({
  selector: 'app-l06-main',
  standalone: true,
  imports: [L06FieldsTableComponent, CommonModule, FormsModule, L06NewRegisterComponent],
